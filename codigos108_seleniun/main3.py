...
results = browser.find_element(By.ID, 'search') #find_element ou elements e usado para pega elementos, usando a calsse By pode selecionar oque vai pegar, ex: TAG, id, classe ou outra coisa, e vai digita o nome do id, tag ou do que selecionou
links = results.find_elements(By.TAG_NAME, 'a')
links[5].click()
#.click() e uma função que vai click no que estiver selecionado
sleep(TIME_TO_WAIT)
